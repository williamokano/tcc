...
int main() {
    ...
    int espessuraAtual = obterEspessura();
...
Um polígono é uma figura composta por 3 ou mais vértices. Um polígono pode ser desenhado de forma livre e a função que desenha um polígono tem o seguinte protótipo:
