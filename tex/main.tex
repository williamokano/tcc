...
A biblioteca \textit{Borland Graphics Interface}, ou também conhecida como BGI, é uma biblioteca gráfica que é distribuída junto a vários compiladores da Borland para o sistema operacional DOS, e eventualmente com suporte a Windows, desde 1987. A biblioteca BGI é menos poderosa que outras bibliotecas como SDL ou OpenGL pois ela foi desenvolvida para a apresentação de gráficos e não aplicações 3D baseadas em eventos. Entretanto, ela possui uma API muito simples de ser utilizada.

\section{GLUT e Free GLUT}
